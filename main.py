...
# ======================== IMPORTS =======================
import requests , os , sys , jwt , pickle , json , binascii , time , urllib3 , base64 , datetime , re , socket , threading , ssl , pytz , aiohttp , traceback , signal  , asyncio
...
[{color}]◎══════════════════════════════════════◎
[FFD700]◉ —͞ＴＩＧＥＲ乡ㅤ友! BOT [9400D3]➤ /spnff ◉
"""
    return result
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]—͞ＴＩＧＥＲ乡ㅤ友! [00FF00]___ —͞ＷＩＬＤ乡ㅤＴＩＧＥＲ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @IshrakShadman\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]—͞ＴＩＧＥＲ乡ㅤ友!ㅤ [FFFF00]!!
"""
...
[{color1}]━━━━━━━━━━━━━━━━━━
[FFD700]◉ —͞ＴＩＧＥＲ乡ㅤ友! BOT [FF69B4]➤ /joke ◉
[{color1}]━━━━━━━━━━━━━━━━━━
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FFD700]◉ —͞ＴＩＧＥＲ乡ㅤ友! BOT [00FF7F]➤ /frt ◉
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FFD700]◉ —͞ＴＩＧＥＲ乡ㅤ友! BOT [FF69B4]➤ /grt ◉
"""
...
[{c1}]{prediction}
[{border_color}]━━━━━━━━━━━━━━━━━━━━━
[FF69B4]🔮 Powered By [FFFF00]—͞ＴＩＧＥＲ乡ㅤ友!
[{border_color}]━━━━━━━━━━━━━━━━━━━━━"""
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔═════════════╗
[FFFFFF] ✨ YT= @IshrakShadman FOLLOW   
[FFFFFF]      THANKS FOR USE MY BOT❤️   
[FFFFFF]           AND THANKS FOR YOUR SUPPORT❤️ 
[FF0000]╠═════════════╣
[FFD700] ⚡ OWNER REAL NAME : [FFFFFF]ＷＩＬＤ乡ㅤＴＩＧＥＲ
[FFD700] ✨ কেউ GUILD BOT [FF0000]কিনতে চাইলে message করবেন, [00FFFF] Telegram: @IshrakShadman
[FF0000]╠═════════════╣
[FFD700] ✨ Developer —͟͞͞ </> —͞ＷＩＬＤ乡ㅤＴＩＧＥＲ ❄️  ⚡
[FFD700]╚═════════════╝"""
...
# GLOBAL BLOCKED NAMES
                        BLOCKED_NAMES = [" chinkor", "Chinkor", "shihab", " shihab", "kapil", " Kapil", "ছিংকর", " ছিংকর", "শিহাব", " শিহাব", "chinkorroy", " chinkorroy","chinkor_roy", " chinkor_roy", "chink0r", " cHiNk0r", "chiNkr", " chinkr","", "chINKOR", "xinkr", "xinkor", " xinkr", " xinkor", ]  # Protected names
...
[00FF00]Use: /b [name]"""
 ...
 # ==============================================================
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "cr", "hi", "sb"):
                            ...
                            s1 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 01ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/ghost [code]"""
                            ...
                            s2 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 02ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]@max"""
                            ...
                            s3 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 03ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/fast [uid] [emote]"""
                            ...
                            s4 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 04ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/check [uid]"""
                            ...
                            s5 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 05ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/joinroom [id] [pass]"""        
                            ...
                            s6 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 06ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
"""
                            ...
                            s7 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 07ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/later [name]"""
                            ...
                            s8 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 08ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/dm [uid]"""
                            ...
                            s9 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 09ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/frt [n1]&[n2]"""
                            ...
                            s10 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 10ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/joke
   """
                            ...
                            s11 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 11ㅤㅤ[FF75EA] │
[FF75EA]╰──────────╯
...
[FF2C03]└─► [FFFDED]/on
   """
                            ...
                            s12 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] ＴＩＧＥＲ乡 MENU 12ㅤㅤ[FF75EA] │
[FF75EA]╰──────────╯
...
[FCFEFF]⚡ [FFFF00]ＷＩＬＤ乡ㅤＴＩＧＥＲ [00FF00]⚡

[2BFF00] ACTIVE STATUS: 50/1 online

[FF0000]◈ [FFFF00]TELEGRAM [00FFFF]@IshrakShadman
[FFD700]╚══════════════╝"""
                            ...
                            guild = """
[C][B][2BC0FF]════════════
[FCFEFF]Wʟᴄ TO ＷＩＬＤ乡  Gᴜɪʟᴅ
[2BC0FF]════════════[FFFFFF][B]
❀️ বর্তমান যে অবস্থা কেউ কাউকে কোন ফাইল দেয় না 

[2BC0FF]❀️ গিল্ড গোলরি 2000 কম হলে কিক করবো 

[FCFEFF] গিল্ডে পেলোয়ার সম্মান করতে হবে 

[B][C][2BC0FF] FOLLOW MY TELEGRAM : @IshrakShadman
